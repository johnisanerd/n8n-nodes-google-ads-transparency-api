...
import { properties } from './ApifyAdsTransparency.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = '1SOrTCb3mzaT2TXHK' as string;

export const PACKAGE_NAME = 'n8n-nodes-google-ads-transparency-api' as string;
export const CLASS_NAME = 'ApifyAdsTransparency' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'google-ads-transparency-app' as string;

export const DISPLAY_NAME = 'Google Ads Transparency' as string;
export const DESCRIPTION =
	'Get an advertiser\'s ads from the Google Ads Transparency Center with formats and run dates' as string;

export class ApifyAdsTransparency implements INodeType {
